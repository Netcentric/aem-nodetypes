...
The CND exposed by this Maven artifact is exported from a running plain AEM version through the [JCR Web Console Plugin 1.1.0+](https://central.sonatype.com/artifact/org.apache.sling/org.apache.sling.jcr.webconsole) (see [SLING-9945](https://issues.apache.org/jira/browse/SLING-9945)) via the endpoint `/system/console/status-JCR%20CND.txt`.
